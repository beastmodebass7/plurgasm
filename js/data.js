...
const FESTIVALS = [
  { id:'edc-mexico', name:'EDC MEXICO', tagline:'Under the Electric Sky — CDMX', location:'Autódromo Hermanos Rodríguez, Mexico City', dates:'Feb 19–21, 2027', sortDate:'2027-02-19', endDate:'2027-02-21', days:3, age:'18+', type:'international', typeLabel:'International', genres:['EDM','House','Techno','Trance','Bass'], desc:'One of the largest EDM events in Latin America. Insomniac production quality in Mexico City\'s iconic Formula 1 circuit.', headliners: [], url:'https://mexico.electricdaisycarnival.com', featured:false, detailPage:null, region:'international', organizer:'Insomniac', image:null },
  { id:'tomorrowland-winter', name:'TOMORROWLAND WINTER', tagline:'The Ski Resort Edition', location:'Alpe d\'Huez, France', dates:'Mar 20–27, 2027', sortDate:'2027-03-20', endDate:'2027-03-27', days:7, age:'18+', type:'international', typeLabel:'International', genres:['EDM','Techno','House','Trance','DnB'], desc:'Tomorrowland\'s ski resort spin-off in the French Alps. Seven stages spread across the Alpe d\'Huez estate — high-altitude restaurants, mountainside terraces, and the resort itself — for a full week of riding by day and dancing by night. 2027 lineup TBA.', headliners: [], url:'https://tomorrowlandwinter.com', featured:false, detailPage:null, region:'international', organizer:'Tomorrowland', image:null },
  { id:'ultra-miami', name:'ULTRA MIAMI', tagline:'World\'s Premier Electronic Festival', location:'Bayfront Park, Miami FL', dates:'Mar 26–28, 2027', sortDate:'2027-03-26', endDate:'2027-03-28', days:3, age:'18+', type:'mega', typeLabel:'Mega Festival', genres:['EDM','House','Techno','Trance','Bass'], desc:'One of the world\'s biggest electronic festivals, taking over Bayfront Park in downtown Miami every March across 7 stages — mainstage, RESISTANCE techno, Live Stage, and the Worldwide arenas. The anchor of Miami Music Week. 2027 lineup TBA.', headliners: [], url:'https://ultramusicfestival.com', featured:true, detailPage:null, region:'southeast', organizer:'Ultra Enterprises', lat:25.7751, lng:-80.1869, image:null },
  { id:'coachella', name:'COACHELLA', tagline:'Valley of the Sun', location:'Empire Polo Club, Indio CA', dates:'Apr 9–11 + Apr 16–18, 2027', sortDate:'2027-04-09', endDate:'2027-04-18', days:6, age:'All Ages', type:'mega', typeLabel:'Mega Festival', genres:['EDM','House','Techno','Indie','Hip-Hop'], desc:'America\'s most famous festival, running two identical weekends at the Empire Polo Club. The Sahara tent and Yuma warehouse carry serious electronic programming across the California desert. 2027 lineup TBA — Coachella usually announces between October and December.', headliners: [], url:'https://coachella.com', featured:false, detailPage:null, region:'west', organizer:'Goldenvoice', lat:33.6803, lng:-116.2372, image:null },
  { id:'beyond-wonderland', name:'BEYOND WONDERLAND', tagline:'Fall Down the Rabbit Hole', location:'NOS Events Center, San Bernardino CA', dates:'Mar 26–27, 2027', sortDate:'2027-03-26', endDate:'2027-03-27', days:2, age:'18+', type:'regional', typeLabel:'Regional', genres:['EDM','Bass','House','Techno'], desc:'Insomniac\'s Alice in Wonderland themed festival and one of SoCal\'s longest-running raves. Immersive themed stages, costumed performers, and a heavy house and bass lineup at the NOS Events Center. 2027 lineup TBA.', headliners: [], url:'https://beyondwonderland.com', featured:false, detailPage:null, region:'west', organizer:'Insomniac', lat:34.0975, lng:-117.2873, image:null },
  { id:'edc', name:'EDC LAS VEGAS', lat:36.2722, lng:-115.0107, tagline:'Dusk Till Dawn — Two Weekends', location:'Las Vegas Motor Speedway, NV', dates:'May 14–16 + May 21–23, 2027', sortDate:'2027-05-14', endDate:'2027-05-23', days:6, age:'18+', type:'mega', typeLabel:'Mega Festival', region:'west', organizer:'Insomniac', genres:['EDM','House','Techno','Trance','Bass'], desc:'The crown jewel of North American raves expands to two weekends for the first time in its history — EDC Dusk (May 14–16) and EDC Dawn (May 21–23), with a 12-day Dusk Till Dawn run bridging them. Lower per-weekend capacity means more room and easier travel, with the same kinetic stages under the electric sky. 2027 lineup TBA.', headliners:[], url:'https://lasvegas.electricdaisycarnival.com', detailPage:'festivals/edc-las-vegas.html', featured:true, cardTheme:{ bg:'linear-gradient(145deg, #10081e 0%, #180a2e 50%, #0c0618 100%)', border:'rgba(182,77,255,0.3)', glow:'rgba(182,77,255,0.07)', accent:'#b64dff', label:'rgba(182,77,255,0.8)' }, image:null },
  { id:'lightning-in-a-bottle', name:'LIGHTNING IN A BOTTLE', tagline:'The Conscious Festival', location:'Buena Vista Lake, Bakersfield CA', dates:'May 26–30, 2027', sortDate:'2027-05-26', endDate:'2027-05-30', days:5, age:'All Ages', type:'underground', typeLabel:'Underground', genres:['Psychedelic','House','Bass','Jam'], desc:'A conscious camping festival blending electronic music, art, yoga, and community. One of the most beloved boutique festivals in the US.', headliners: [], url:'https://lightninginabottle.org', featured:false, detailPage:null, region:'west', organizer:'Do LaB', lat:35.7989, lng:-119.7532, image:null },
  { id:'movement', name:'MOVEMENT DETROIT', lat:42.3291, lng:-83.0458, tagline:'The Birthplace of Techno', location:'Hart Plaza, Detroit MI', dates:'May 29–31, 2027', sortDate:'2027-05-29', endDate:'2027-05-31', days:3, age:'18+', type:'underground', typeLabel:'Underground', region:'midwest', organizer:'Paxahau', genres:['Techno','House','Industrial'], desc:'Memorial Day weekend at the birthplace of techno. Raw. Industrial. Undeniably Detroit. Multiple stages packed into Hart Plaza on the riverfront, plus one of the densest afterparty circuits in dance music. 2027 lineup TBA.', headliners:[], url:'https://movement.us', detailPage:'festivals/movement-detroit.html', featured:false, cardTheme:{ bg:'linear-gradient(145deg, #080810 0%, #0d0818 50%, #060610 100%)', border:'rgba(182,77,255,0.25)', glow:'rgba(120,60,255,0.07)', accent:'#b64dff', label:'rgba(182,77,255,0.7)' }, image:null },
  { id:'project-glow', name:'PROJECT GLOW', lat:38.8893, lng:-76.9723, tagline:'The Capital\'s Dance Music Weekend', location:'RFK Festival Grounds, Washington DC', dates:'Jun 5–6, 2027', sortDate:'2027-06-05', endDate:'2027-06-06', days:2, age:'18+', type:'regional', typeLabel:'East Coast', region:'northeast', organizer:'Insomniac', genres:['EDM','House','Bass','Techno'], desc:'The East Coast\'s crown jewel. Born from Club GLOW — the longest-running electronic music promoter on the East Coast. Three custom stages, immersive art, and the electric energy of the nation\'s capital.', headliners: [], url:'https://projectglow.frontgatetickets.com/', detailPage:'festivals/project-glow.html', featured:true, cardTheme:{ bg:'linear-gradient(145deg, #080d1f 0%, #0a1628 50%, #060c1a 100%)', border:'rgba(0,229,255,0.28)', glow:'rgba(0,229,255,0.06)', accent:'#00e5ff', label:'rgba(0,229,255,0.7)' }, image:null },
  { id:'bonnaroo', name:'BONNAROO', tagline:'The Farm', location:'Manchester, TN', dates:'Jun 10–13, 2027 (est)', sortDate:'2027-06-10', endDate:'2027-06-13', days:4, age:'All Ages', type:'mega', typeLabel:'Mega Festival', genres:['EDM','House','Jam','Indie','Hip-Hop'], desc:'One of America\'s original camping festivals. Strong electronic stages alongside rock, hip-hop, and jam bands in Tennessee.', headliners: [], url:'https://bonnaroo.com', featured:false, detailPage:null, region:'southeast', organizer:'C3 Presents', lat:35.4676, lng:-86.0914, image:null },
  { id:'eforest', name:'ELECTRIC FOREST', lat:43.6324, lng:-86.3447, tagline:'Back in the Michigan Woods', location:'Rothbury, Michigan', dates:'Jun 24–27, 2027 (est)', sortDate:'2027-06-24', endDate:'2027-06-27', days:4, age:'All Ages', type:'regional', typeLabel:'Regional', region:'midwest', organizer:'Insomniac', genres:['Bass','Jam','Psychedelic','House'], desc:'A forest transformed by light and sound. Sherwood Forest\'s light installations, a String Cheese Incident residency, and a deep electronic bill across bass, house, and jam. Music meets nature meets magic in the Michigan woods. 2027 lineup TBA.', headliners:[], url:'https://electricforest.com', detailPage:'festivals/electric-forest.html', featured:false, cardTheme:{ bg:'linear-gradient(145deg, #040e06 0%, #081808 50%, #040e06 100%)', border:'rgba(61,255,133,0.25)', glow:'rgba(61,255,133,0.06)', accent:'#3dff85', label:'rgba(61,255,133,0.8)' }, image:'images/festivals/electric-forest.webp' },
  { id:'tomorrowland', name:'TOMORROWLAND', tagline:'Two Weekends in Boom', location:'Boom, Belgium', dates:'Jul 16–18 + Jul 23–25, 2027 (est)', sortDate:'2027-07-16', endDate:'2027-07-25', days:6, age:'All Ages', type:'international', typeLabel:'World', region:'international', organizer:'Tomorrowland', genres:['EDM','House','Techno','Trance'], desc:'The world\'s most iconic festival, staged over two identical weekends at De Schorre in Boom. 500+ artists across 16 elaborately built stages, a new narrative theme each year, and 400,000+ people from every corner of the planet. 2027 theme and lineup TBA.', headliners:[], url:'https://tomorrowland.com', detailPage:'festivals/tomorrowland.html', featured:true, cardTheme:{ bg:'linear-gradient(145deg, #160f00 0%, #1e1500 50%, #0f0a00 100%)', border:'rgba(255,184,0,0.28)', glow:'rgba(255,184,0,0.06)', accent:'#ffb800', label:'rgba(255,184,0,0.8)' }, image:'images/festivals/tomorrowland.webp' },
  { id:'dirtybird-northern-nights', name:'DIRTYBIRD CAMPOUT X NORTHERN NIGHTS', tagline:'Redwoods, river, and bass', location:"Cook's Valley Campground, Piercy, CA", dates:'Jul 16–18, 2027 (est)', sortDate:'2027-07-16', endDate:'2027-07-18', days:3, age:'18+', type:'regional', typeLabel:'Camping Festival', genres:['Bass','House','Techno','Dubstep','Experimental'], desc:'Two Northern California camping institutions joined into one — three days under towering redwoods on the Eel River, blending Dirtybird house with Northern Nights bass and a swim-between-sets vibe.', url:'https://northernnights.org/', featured:false, detailPage:null, cardTheme:null, region:'west', organizer:'Dirtybird', lat:39.9785, lng:-123.7892, headliners:[], image:null },
  { id:'lollapalooza', name:'LOLLAPALOOZA', tagline:'Grant Park Goes Off', location:'Grant Park, Chicago IL', dates:'Jul 29 – Aug 1, 2027 (est)', sortDate:'2027-07-29', endDate:'2027-08-01', days:4, age:'All Ages', type:'mega', typeLabel:'Mega Festival', genres:['EDM','House','Hip-Hop','Rock','Indie'], desc:'Chicago\'s legendary 4-day festival in Grant Park. Strong electronic stage every year in one of America\'s greatest cities.', headliners: [], url:'https://lollapalooza.com', featured:false, detailPage:null, region:'midwest', organizer:'C3 Presents', lat:41.8700, lng:-87.6189, image:'images/festivals/lollapalooza.webp' },
  { id:'hard', name:'HARD SUMMER', tagline:'HARD Summer Music Festival', location:'Hollywood Park, Inglewood, CA', dates:'Jul 31 – Aug 1, 2027 (est)', sortDate:'2027-07-31', endDate:'2027-08-01', days:2, age:'18+', type:'mega', typeLabel:'Mega Festival', genres:['EDM','House','Techno','Bass','Hip-Hop'], desc:'A genre-spanning LA blowout from Insomniac, returning to the 300-acre Hollywood Park next to SoFi Stadium for two days of electronic, bass, and hip-hop across multiple stages.', url:'https://www.hardsummer.com/', featured:false, detailPage:null, cardTheme:null, region:'west', organizer:'Insomniac', lat:33.9530, lng:-118.3392, headliners:[], image:'images/festivals/hard-summer.webp' },
  { id:'elements-festival', name:'ELEMENTS FESTIVAL', tagline:'An Escape Unlike Any Other', location:'Pocono Raceway, Long Pond, PA', dates:'Aug 6–8, 2027 (est)', sortDate:'2027-08-06', endDate:'2027-08-08', days:3, age:'18+', type:'regional', typeLabel:'Regional Festival', genres:['Bass','House','Techno','Dubstep','DnB','Trance','Experimental'], desc:'Elements transforms the forested grounds of Pocono Raceway into an immersive camping festival built around elemental stages — Fire, Water, Air, Earth — with large-scale art installations, art cars, and wellness programming spanning bass, house, techno, drum & bass, and experimental electronic. 2027 lineup TBA.', url:'https://www.elementsfest.us/', featured:false, detailPage:'festivals/elements-music-arts-festival.html', cardTheme:null, region:'northeast', organizer:null, lat:41.0539, lng:-75.5113, headliners:[], image:null },
  { id:'up-in-the-sky', name:'UP IN THE SKY', tagline:'Music in the Mountains', location:'Buttermilk, Aspen, CO', dates:'Aug 6–7, 2027 (est)', sortDate:'2027-08-06', endDate:'2027-08-07', days:2, age:'All Ages', type:'regional', typeLabel:'Mountain Festival', genres:['House','EDM','Indie'], desc:'A two-day festival at the base of Buttermilk Mountain in Aspen, blending massive house headliners with indie-pop and electronic acts, all against a panoramic Rockies backdrop. Presented by C3 Presents.', url:'https://www.upintheskyfestival.com', featured:false, detailPage:'festivals/up-in-the-sky.html', cardTheme:null, region:'west', organizer:'C3 Presents', lat:39.2044, lng:-106.8608, headliners:[], image:null },
  { id:'ilesoniq', name:'ÎLESONIQ', tagline:'Parc Jean-Drapeau', location:'Parc Jean-Drapeau, Montréal, QC', dates:'Aug 7–8, 2027 (est)', sortDate:'2027-08-07', endDate:'2027-08-08', days:2, age:'18+', type:'mega', typeLabel:'Mega Festival', genres:['EDM','House','Techno','Bass','Trance'], desc:"Montréal's massive two-day electronic festival on the island of Parc Jean-Drapeau, drawing global headliners across house, techno, bass and trance, with a companion ÎLESONIQ in the City night downtown. 2027 lineup TBA.", url:'https://ilesoniq.com', featured:false, detailPage:null, cardTheme:null, region:'canada', organizer:'evenko', lat:45.5167, lng:-73.5333, headliners:[], image:null },
  { id:'bass-canyon', name:'BASS CANYON', tagline:'Curated by Excision', location:'Gorge Amphitheatre, George, WA', dates:'Aug 13–15, 2027 (est)', sortDate:'2027-08-13', endDate:'2027-08-15', days:3, age:'18+', type:'regional', typeLabel:'Bass Festival', genres:['Dubstep','Bass','Riddim'], desc:'Excision curates three nights of pure bass at the Gorge, one of the most beautiful venues in North America. Camping under the stars on the Columbia River.', url:'https://www.basscanyon.com', featured:false, detailPage:'festivals/bass-canyon.html', cardTheme:null, region:'west', organizer:'Excision', lat:47.0989, lng:-119.9908, headliners:[] },
  ...
  { id:'basscon-wasteland', name:'BASSCON WASTELAND', tagline:'Harder Styles Massive', location:'NOS Events Center, San Bernardino, CA', dates:'Sep 4–5, 2026', sortDate:'2026-09-04', endDate:'2026-09-05', days:2, age:'18+', type:'regional', typeLabel:'Hardstyle Festival', genres:['Hardstyle','Hard Dance','Bass'], desc:'Insomniac\'s Basscon brand goes all-in on the harder styles of dance music. Two days of hardstyle, hardcore, and hard techno at the NOS Events Center over Labor Day weekend.', url:'https://wasteland.bassconmassive.com', featured:false, detailPage:'festivals/basscon-wasteland.html', cardTheme:null, region:'west', lat:34.0882, lng:-117.2921, headliners:['Angerfist','Sub Zero Project','D-Sturb','Darren Styles','Kayzo','Ben Nicky','DJ Isaac','Rooler'], organizer:'Insomniac' },
  { id:'bridge-city-block-party', name:'BRIDGE CITY BLOCK PARTY', tagline:'Portland Waterfront Bass', location:'Tom McCall Waterfront Park, Portland, OR', dates:'Sep 5–6, 2026', sortDate:'2026-09-05', endDate:'2026-09-06', days:2, age:'18+', type:'regional', typeLabel:'Bass Festival', genres:['Bass','Dubstep','House'], desc:'Portland\'s biggest bass party takes over the downtown waterfront for two days, headlined by Subtronics and Zeds Dead. Presented by Red Cube.', url:'https://bridgecityblockparty.com', featured:false, detailPage:'festivals/bridge-city-block-party.html', cardTheme:null, region:'west', lat:45.5165, lng:-122.6764, headliners:['Subtronics','Zeds Dead','Whethan','Dr. Fresch','Eprom','Zingara','Saka','Gardella'], organizer:'Red Cube Presents' },
  ...
  { id:'something-wicked', name:'SOMETHING WICKED', tagline:'Halloween in Houston', location:'Sam Houston Race Park, Houston TX', dates:'Oct 30–31, 2026 (est)', sortDate:'2026-10-30', endDate:'2026-10-31', days:2, age:'18+', type:'regional', typeLabel:'Regional', genres:['EDM','Bass','House','Techno'], desc:'Texas\'s biggest Halloween electronic festival, from Disco Donnie Presents and NightCulture. Two nights of costumes, horror-themed stages and bass at Sam Houston Race Park.', headliners: [], url:'https://somethingwickedfest.com', featured:false, detailPage:null, region:'southwest', organizer:'Disco Donnie Presents', lat:29.9364, lng:-95.5467, image:null },
  { id:'escape-halloween', name:'ESCAPE HALLOWEEN', tagline:'Psycho Circus', location:'NOS Events Center, San Bernardino, CA', dates:'October 30–31, 2026', sortDate:'2026-10-30', endDate:'2026-10-31', days:2, age:'18+', type:'mega', typeLabel:'Mega Festival', genres:['EDM','House','Techno','Bass','Trance'], desc:'The biggest Halloween rave in North America — Insomniac turns the NOS Events Center into a horror-themed playground of costumed chaos and top electronic talent over Halloween weekend.', url:'https://escapehalloween.com/', featured:false, detailPage:null, cardTheme:null, region:'west', organizer:'Insomniac', lat:34.0975, lng:-117.2873, headliners:[], image:null },
...
const ARTISTS = [
  {
    ...
    tourDates: [
      ...
      // Resolved Aug 2026: SLANDER's tour page listed this at "Northerly Island", but North
      // Coast has been at SeatGeek Stadium, Bridgeview IL since 2021 (Northerly Island was the
      // 2019 venue) — confirmed on northcoastfestival.com. Our festival record is correct and
      // the artist page renders it; the tour page is stale.
...
const FEST_GENRE_ORDER = [
  ...
  'DnB','Riddim','Hardstyle','Hard Dance','Progressive','Psy-Trance','Industrial','Experimental','Indie','Rock'
];
