...
PLURGASM_DATA.festivals = [
  {
    id:'edc-mexico', name:'EDC MEXICO',
    tagline:'Under the Electric Sky — CDMX',
    location:'Autódromo Hermanos Rodríguez, Mexico City',
    dates:'Feb 27 – Mar 1, 2026',
    sortDate:'2026-02-27', endDate:'2026-03-01',
    days:3, age:'18+',
    type:'international', typeLabel:'International',
    genres:['EDM','House','Techno','Trance','Bass'],
    desc:'One of the largest EDM events in Latin America. Same Insomniac production as Las Vegas but in Mexico City\'s iconic Formula 1 circuit venue. Draws massive international crowds.',
    url:'https://mexico.electricdaisycarnival.com',
    featured:false, detailPage:null, region:'international',
    headliners:[]
  },
  {
    id:'tomorrowland-winter', name:'TOMORROWLAND WINTER',
    tagline:'The Ski Resort Edition',
    location:'Alpe d\'Huez, France',
    dates:'Mar 21–28, 2026', sortDate:'2026-03-21',
    endDate:'2026-03-28', days:7, age:'18+',
    type:'international', typeLabel:'International',
    genres:['EDM','Techno','House','Trance','DnB'],
    desc:'Tomorrowland\'s ski resort spin-off returns to the French Alps. Charlotte de Witte, Steve Aoki, Nina Kraviz, Steve Angello, and more across mountain stages.',
    url:'https://tomorrowlandwinter.com',
    featured:false, detailPage:null, region:'international',
    headliners:['Charlotte de Witte','Steve Aoki','Nina Kraviz','Steve Angello','Netsky']
  },
  {
    id:'ultra-miami', name:'ULTRA MIAMI',
    tagline:'World\'s Premier Electronic Festival',
    location:'Bayfront Park, Miami FL',
    dates:'Mar 27–29, 2026', sortDate:'2026-03-27',
    endDate:'2026-03-29', days:3, age:'18+',
    type:'mega', typeLabel:'Mega Festival',
    genres:['EDM','House','Techno','Trance','Bass'],
    desc:'The world\'s No.2 festival returns to Downtown Miami. 7 stages, 80% new roster from last year. Carl Cox, Eric Prydz, Armin van Buuren, Major Lazer, John Summit, Sara Landry, ILLENIUM, and more.',
    url:'https://ultramusicfestival.com',
    featured:true, detailPage:null, region:'southeast',
    headliners:['Carl Cox','Eric Prydz','Armin van Buuren','Major Lazer','John Summit','Sara Landry','ILLENIUM','Hardwell','Sebastian Ingrosso B2B Steve Angello']
  },
  {
    id:'coachella', name:'COACHELLA',
    tagline:'Valley of the Sun',
    location:'Empire Polo Club, Indio CA',
    dates:'Apr 10–12 + Apr 17–19, 2026',
    sortDate:'2026-04-10', endDate:'2026-04-19',
    days:6, age:'All Ages',
    type:'mega', typeLabel:'Mega Festival',
    genres:['EDM','House','Techno','Indie','Hip-Hop'],
    desc:'The most famous festival in America. Anyma headlines the Sahara tent alongside Disclosure, and a stacked electronic program runs alongside mainstream headliners in the California desert.',
    url:'https://coachella.com',
    featured:false, detailPage:null, region:'west',
    headliners:['Anyma','Disclosure','Justin Bieber','Sabrina Carpenter','Karol G']
  },
  {
    id:'beyond-wonderland', name:'BEYOND WONDERLAND',
    tagline:'Fall Down the Rabbit Hole',
    location:'NorCal Shoreline, Mountain View CA',
    dates:'Apr 17–18, 2026 (est)',
    sortDate:'2026-04-17', endDate:'2026-04-18',
    days:2, age:'18+',
    type:'regional', typeLabel:'Regional',
    genres:['EDM','Bass','House','Techno'],
    desc:'Insomniac\'s Alice in Wonderland themed festival returns to the Bay Area. Immersive themed stages and strong electronic lineup. Dates estimated — confirm on official site.',
    url:'https://beyondwonderland.com',
    featured:false, detailPage:null, region:'west',
    headliners:[]
  },
  {
    id:'lightning-in-a-bottle', name:'LIGHTNING IN A BOTTLE',
    tagline:'The Conscious Festival',
    location:'Central California (TBA)',
    dates:'May 20–25, 2026 (est)',
    sortDate:'2026-05-20', endDate:'2026-05-25',
    days:5, age:'All Ages',
    type:'underground', typeLabel:'Underground',
    genres:['Psychedelic','House','Bass','Jam'],
    desc:'A conscious camping festival blending electronic music, art, yoga, and community. One of the most beloved boutique festivals in the US. Dates estimated — confirm on official site.',
    url:'https://lightninginabottle.org',
    featured:false, detailPage:null, region:'west',
    headliners:[]
  },
  {
    id:'bonnaroo', name:'BONNAROO',
    tagline:'The Farm',
    location:'Manchester, TN',
    dates:'Jun 11–14, 2026 (est)',
    sortDate:'2026-06-11', endDate:'2026-06-14',
    days:4, age:'All Ages',
    type:'mega', typeLabel:'Mega Festival',
    genres:['EDM','House','Jam','Indie','Hip-Hop'],
    desc:'One of America\'s original camping festivals. Strong electronic stages alongside rock, hip-hop, and jam bands. The Which Stage and the DJ tent consistently pull top electronic acts. Dates estimated — confirm on official site.',
    url:'https://bonnaroo.com',
    featured:false, detailPage:null, region:'southeast',
    headliners:[]
  },
  {
    id:'lollapalooza', name:'LOLLAPALOOZA',
    tagline:'Grant Park Goes Off',
    location:'Grant Park, Chicago IL',
    dates:'Jul 30 – Aug 2, 2026 (est)',
    sortDate:'2026-07-30', endDate:'2026-08-02',
    days:4, age:'All Ages',
    type:'mega', typeLabel:'Mega Festival',
    genres:['EDM','House','Hip-Hop','Rock','Indie'],
    desc:'Chicago\'s legendary 4-day festival in Grant Park. The electronic stage pulls major names every year and the city of Chicago adds to the experience beyond the festival gates. Dates estimated — confirm on official site.',
    url:'https://lollapalooza.com',
    featured:false, detailPage:null, region:'midwest',
    headliners:[]
  },
  {
    id:'burning-man', name:'BURNING MAN',
    tagline:'The Playa',
    location:'Black Rock City, NV (Black Rock Desert)',
    dates:'Aug 30 – Sep 7, 2026 (est)',
    sortDate:'2026-08-30', endDate:'2026-09-07',
    days:8, age:'All Ages',
    type:'underground', typeLabel:'Underground',
    genres:['Techno','House','Psychedelic','Experimental'],
    desc:'Not a festival — a temporary city of 80,000 built on radical self-expression. 24/7 music camps, art cars, and underground stages across the Nevada desert. No headliners, no lineup — just the playa. Dates estimated — confirm on official site.',
    url:'https://burningman.org',
    featured:false, detailPage:null, region:'west',
    headliners:[]
  },
  {
    id:'nocturnal-wonderland', name:'NOCTURNAL WONDERLAND',
    tagline:'The Original',
    location:'Glen Helen Amphitheater, San Bernardino CA',
    dates:'Sep 4–5, 2026 (est)',
    sortDate:'2026-09-04', endDate:'2026-09-05',
    days:2, age:'18+',
    type:'regional', typeLabel:'Regional',
    genres:['Bass','Techno','House','EDM'],
    desc:'Insomniac\'s oldest festival and one of the longest-running in the US. Strong bass and techno programming in SoCal. Dates estimated — confirm on official site.',
    url:'https://nocturnalwonderland.com',
    featured:false, detailPage:null, region:'west',
    headliners:[]
  },
  {
    id:'imagine', name:'IMAGINE MUSIC FESTIVAL',
    tagline:'The Southeast\'s EDM Home',
    location:'Atlanta Motor Speedway, Atlanta GA',
    dates:'Sep 18–20, 2026 (est)',
    sortDate:'2026-09-18', endDate:'2026-09-20',
    days:3, age:'18+',
    type:'regional', typeLabel:'Regional',
    genres:['Bass','EDM','House','Dubstep'],
    desc:'The Southeast\'s biggest electronic festival. Bass-heavy lineup with camping available at Atlanta Motor Speedway. A major anchor for the Southern rave community. Dates estimated — confirm on official site.',
    url:'https://imaginefestival.com',
    featured:false, detailPage:null, region:'southeast',
    headliners:[]
  },
  {
    id:'lost-lands', name:'LOST LANDS',
    tagline:'Excision\'s Dinosaur Kingdom',
    location:'Legend Valley, Thornville OH',
    dates:'Oct 2–4, 2026 (est)',
    sortDate:'2026-10-02', endDate:'2026-10-04',
    days:3, age:'All Ages',
    type:'regional', typeLabel:'Regional',
    genres:['Bass','Dubstep','Riddim','Experimental'],
    desc:'Excision\'s own bass music festival. The most dedicated bass music lineup in North America every year. Prehistoric theme, massive production, camping on-site. Sells out annually. Dates estimated — confirm on official site.',
    url:'https://lostlandsfestival.com',
    featured:true, detailPage:null, region:'midwest',
    headliners:['Excision']
  },
  {
    id:'something-wicked', name:'SOMETHING WICKED',
    tagline:'Halloween in Houston',
    location:'NRG Park, Houston TX',
    dates:'Oct 30–31, 2026 (est)',
    sortDate:'2026-10-30', endDate:'2026-10-31',
    days:2, age:'18+',
    type:'regional', typeLabel:'Regional',
    genres:['EDM','Bass','House','Techno'],
    desc:'Insomniac\'s Halloween festival in Houston. Two nights of costumes and music at NRG Park. The South\'s biggest Halloween EDM event every year. Dates estimated — confirm on official site.',
    url:'https://somethingwickedfest.com',
    featured:false, detailPage:null, region:'southwest',
    headliners:[]
  },
  {
    id:'day-of-the-dead', name:'DAY OF THE DEAD',
    tagline:'Dia de los Muertos',
    location:'Los Angeles, CA',
    dates:'Nov 1–2, 2026 (est)',
    sortDate:'2026-11-01', endDate:'2026-11-02',
    days:2, age:'18+',
    type:'regional', typeLabel:'Regional',
    genres:['Techno','House','Bass','EDM'],
    desc:'Insomniac\'s Dia de los Muertos festival in LA. Halloween weekend electronic music with cultural art installations and a massive costume turnout. Dates estimated — confirm on official site.',
    url:'https://insomniac.com',
    featured:false, detailPage:null, region:'west',
    headliners:[]
  },
  {
    id:'edc-orlando', name:'EDC ORLANDO',
    tagline:'Under the Electric Sky — Florida',
    location:'Tinker Field, Orlando FL',
    dates:'Nov 7–8, 2026 (est)',
    sortDate:'2026-11-07', endDate:'2026-11-08',
    days:2, age:'18+',
    type:'regional', typeLabel:'Regional',
    genres:['EDM','House','Techno','Bass','Trance'],
    desc:'The East Coast\'s EDC. Smaller than Las Vegas but same Insomniac production quality. A great entry point into the EDC universe for Florida and southeast ravers. Dates estimated — confirm on official site.',
    url:'https://orlando.electricdaisycarnival.com',
    featured:false, detailPage:null, region:'southeast',
    headliners:[]
  },
  {
    id:'dreamstate', name:'DREAMSTATE SOCAL',
    tagline:'The Trance Kingdom',
    location:'NOS Event Center, San Bernardino CA',
    dates:'Nov 21–22, 2026 (est)',
    sortDate:'2026-11-21', endDate:'2026-11-22',
    days:2, age:'18+',
    type:'regional', typeLabel:'Regional',
    genres:['Trance','Progressive','Psy-Trance'],
    desc:'North America\'s premier trance festival. Armin van Buuren, Ferry Corsten, Paul van Dyk, and the entire trance family converge in SoCal. A must for trance fans. Dates estimated — confirm on official site.',
    url:'https://dreamstateusa.com',
    featured:false, detailPage:null, region:'west',
    headliners:['Armin van Buuren']
  },
  {
    id:'countdown-nye', name:'COUNTDOWN NYE',
    tagline:'New Year\'s Eve Under the Electric Sky',
    location:'NOS Event Center, San Bernardino CA',
    dates:'Dec 31, 2026',
    sortDate:'2026-12-31', endDate:'2026-12-31',
    days:1, age:'18+',
    type:'mega', typeLabel:'Mega Festival',
    genres:['EDM','House','Techno','Bass','Trance'],
    desc:'Insomniac\'s massive New Year\'s Eve festival. Ring in the new year with a midnight countdown, confetti, and a stacked electronic lineup. One of the largest NYE events in the US.',
