...
const FESTIVALS = [
  ...
  { id:'up-in-the-sky', name:'UP IN THE SKY', tagline:'Music in the Mountains', location:'Buttermilk, Aspen, CO', dates:'Aug 7–8, 2026', sortDate:'2026-08-07', endDate:'2026-08-08', days:2, age:'All Ages', type:'regional', typeLabel:'Mountain Festival', genres:['House','Dance','Indie'], desc:'A two-day festival at the base of Buttermilk Mountain in Aspen, blending massive house headliners with indie-pop and electronic acts, all against a panoramic Rockies backdrop. Presented by C3 Presents.', url:'https://www.upintheskyfestival.com', featured:false, detailPage:'festivals/up-in-the-sky.html', cardTheme:null, region:'west', organizer:'C3 Presents', lat:39.2044, lng:-106.8608, headliners:['John Summit','Dom Dolla','Empire of the Sun','Parcels','Polo & Pan','Passion Pit'], image:null },
