...
const FESTIVALS = [
  ...
  { id:'dirtybird-northern-nights', name:'DIRTYBIRD CAMPOUT X NORTHERN NIGHTS', tagline:'Redwoods, river, and bass', location:"Cook's Valley Campground, Piercy, CA", dates:'Jul 16–18, 2027 (est)', sortDate:'2027-07-16', endDate:'2027-07-18', days:3, age:'18+', type:'regional', typeLabel:'Camping Festival', genres:['Bass','House','Techno','Dubstep','Experimental'], desc:'Two Northern California camping institutions joined into one — three days under towering redwoods on the Eel River, blending Dirtybird house with Northern Nights bass and a swim-between-sets vibe.', url:'https://northernnights.org/', featured:false, detailPage:null, cardTheme:null, region:'west', organizer:null, lat:39.9785, lng:-123.7892, headliners:[], image:null },
